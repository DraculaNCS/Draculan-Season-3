# **Draculan Series 3 \- Official Tournament Rulebook**
...
**Event Name:** Draculan Series 3 – Counter-Strike 2 Open LAN
...
**Dates:** **November 20–23, 2025** (Thursday–Sunday)

**Location:** Nexus Gamers Pub, Bucharest

**Team Cap:**  
Maximum of **24 teams** may participate. Registration is open to any team (first-come, first-served).  
...
A registration fee of **€800 (+VAT)** per team (covers 5 players \+ 1 coach) is required to confirm entry.  
Registration is first-come, first-served.  
Sign-ups close automatically on **November 6, 2025 at 23:59 (Bucharest time)**.
...
**VRS Seeding:**  
In line with Valve’s guidelines for Tier 2 events, Draculan Series 3 will use VRS rankings to seed teams into the Main Event. Once registration closes (approximately two weeks before the event), the top 8 teams by VRS rank among the registered teams will be seeded directly into the Main Event bracket. 

The seeding shall be based on the official VRS ranking released by Valve on **November 3, 2025**. This seeding is applied regardless of whether a registered team is in the VRS top 12, as the restriction on inviting top 12 teams applies only to closed or direct invitation formats, not to open sign-up events. The remaining registered teams will begin in the Open LAN Group Stage on Day 1 to earn their place in the Main Event.  
...
Draculan Series 3 spans **four days**, featuring a **GSL-style group stage** followed by a **double-elimination playoff bracket**. With **24 teams** signed up by the registration cutoff date, the format is structured as follows:

**Day 1 – Group Stage:**  
16 teams compete in **4 GSL groups** of **4 teams** each.  
Group winners and runners-up advance to the Playoffs.

**Days 2–4 – Playoffs:**  
 A **16-team double-elimination bracket** begins, combining:

* The **8 advancing teams** from the Group Stage

* The **8 highest VRS-ranked teams** directly seeded into the Playoffs
...
Each group will contain exactly one team from each pot. The live draw will be held on **November 6, 2025**, and broadcast on the official **Draculan Kick.com channel \-** https://kick.com/draculancs.
...
A total of **16 teams** compete in the Playoffs:

* **8 teams advancing from the Group Stage** (group winners \+ runners-up)
...
* **Opening Round (Round 1): Best-of-1 (BO1)**

* All subsequent matches are **Best-of-3 (BO3)**, including:
...
The **8 VRS-seeded teams** and the **8 Group Stage qualifier teams** are paired in the Opening Round (BO1) as follows:
...
* **Game Version:** Counter-Strike 2 (latest updated version on Steam by November 20\) will be used for all matches and will not change, regardless of game updates. 
...
* **Subsequent Maps in a BO3:**  
  ...
  When a team picks a map, the **opponent chooses starting side**.
...
* All participating teams will be **seeded before the tournament begins** by the Organizer based into four pots (with Pot 1 having the best-rated teams allocated, Pot 2 the second-best-rated, etc.) based on VRS, HLTV rank and Competitive Results. 

* In every match (Group Stage & Playoffs), the **higher-seeded team** is the team that belongs to a higher value pot and always has priority to choose either:  
   a) map veto order, **or**  
   b) starting side.

### **Best-of-1 (Bo1) Pick/Ban Process**

1. The higher seed chooses to be Team A or Team B.
...
6. **Team B chooses the starting side** on the selected map.
...
6. **Team B removes 1 map.**

7. **Team A removes 1 map.**

8. The remaining map becomes Map 3 (decider).
...
The Draculan Series 3 tournament prize pool is fully crowdfunded by team entry fees. A total of **24 teams** have registered, each paying **€800 (+VAT)**.
...
Teams withdrawing within **14 days of the event (after November 6, 2025\)** are not eligible for any refund, regardless of circumstance. 
...
Let’s make this a memorable event for everyone:  players, viewers, and staff alike. **Good luck & have fun to all teams, and welcome to Draculan Series 3\!**
